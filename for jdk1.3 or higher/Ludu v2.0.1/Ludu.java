...
public class Ludu extends JWindow implements ActionListener, KeyListener, java.io.Serializable
{
   ...
   {
         JOptionPane.showMessageDialog( null, "Please change display resolution to 800X600 pixels( if not set )\nand press OK", "Change resolution", JOptionPane.INFORMATION_MESSAGE );
